...
public partial class ApiController
{
    ...
    public Task Client_GroupPairChangeUserInfo(GroupPairUserInfoDto userInfo)
    {
        ...
        ExecuteSafely(() =>
        {
            if (string.Equals(userInfo.UID, PublicUserID, StringComparison.Ordinal)) _pairManager.SetGroupStatusInfo(userInfo);

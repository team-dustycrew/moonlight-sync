...
public sealed class MoonlightMediator : IHostedService
{
    ...
    public MoonlightMediator(ILogger<MoonlightMediator> logger, PerformanceCollectorService performanceCollector, MoonlightConfigService moonlightConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting MoonlightMediator");
        ...
        _logger.LogInformation("Started MoonlightMediator");

...
public class DalamudUtilService : IHostedService, IMediatorSubscriber
{
    ...
    public DalamudUtilService(ILogger<DalamudUtilService> logger, IClientState clientState, IObjectTable objectTable, IFramework framework,
        ...
        BlockedCharacterHandler blockedCharacterHandler, MoonlightMediator mediator, PerformanceCollectorService performanceCollector,
        MoonlightConfigService configService)
    {
        _logger = logger;

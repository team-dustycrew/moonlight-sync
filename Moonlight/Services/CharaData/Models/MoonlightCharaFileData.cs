...
public record MoonlightCharaFileData
{
    ...
    public MoonlightCharaFileData() { }
    public MoonlightCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static MoonlightCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<MoonlightCharaFileData>(Encoding.UTF8.GetString(data))!;
    }

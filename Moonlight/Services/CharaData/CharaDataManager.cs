...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataManager(ILogger<CharaDataManager> logger, ApiController apiController,
        ...
        MoonlightMediator moonlightMediator, IpcManager ipcManager, DalamudUtilService dalamudUtilService,
        ...
        CharaDataCharacterHandler charaDataCharacterHandler, PairManager pairManager) : base(logger, moonlightMediator)
    {
        ...
        moonlightMediator.Subscribe<ConnectedMessage>(this, (msg) =>
        {
            _connectCts?.Cancel();
            _connectCts?.Dispose();
            _connectCts = new();
        ...
        moonlightMediator.Subscribe<DisconnectedMessage>(this, (msg) =>
        {
            _ownCharaData.Clear();
            _metaInfoCache.Clear();
            _sharedWithYouData.Clear();
    ...
    public Task<(MoonlightCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
    ...
    public void SaveMoonlightCharaFile(string description, string filePath)
    {

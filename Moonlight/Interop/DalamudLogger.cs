...
internal sealed class DalamudLogger : ILogger
{
    ...
    public DalamudLogger(string name, MoonlightConfigService moonlightConfigService, IPluginLog pluginLog, bool hasModifiedGameFiles)
    {
        _name = name;
    ...
    {
        return (int)_moonlightConfigService.Current.LogLevel <= (int)logLevel;
    }

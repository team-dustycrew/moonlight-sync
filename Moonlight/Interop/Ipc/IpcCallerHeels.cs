...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(ILogger<IpcCallerHeels> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, MoonlightMediator moonlightMediator)
    {
        _logger = logger;
    ...
    {
        _moonlightMediator.Publish(new HeelsOffsetMessage());
    }

...
namespace Moonlight.PlayerData.Services;
...
public sealed class CacheCreationService : DisposableMediatorSubscriberBase
{
    ...
    public CacheCreationService(ILogger<CacheCreationService> logger, MoonlightMediator mediator, GameObjectHandlerFactory gameObjectHandlerFactory,

...
public class DownloadUi : WindowMediatorSubscriberBase
{
    ...
    public DownloadUi(ILogger<DownloadUi> logger, DalamudUtilService dalamudUtilService, MoonlightConfigService configService,
        FileUploadManager fileTransferManager, MoonlightMediator mediator, UiSharedService uiShared, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Moonlight Downloads", performanceCollectorService)
    {

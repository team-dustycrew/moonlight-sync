...
public class PopoutProfileUi : WindowMediatorSubscriberBase
{
    ...
    public PopoutProfileUi(ILogger<PopoutProfileUi> logger, MoonlightMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, MoonlightConfigService moonlightConfigService,
        MoonlightProfileManager moonlightProfileManager, PairManager pairManager, PerformanceCollectorService performanceCollectorService) : base(logger, mediator, "###MoonlightPopoutProfileUI", performanceCollectorService)
    {
        ...
        Mediator.Subscribe<CompactUiChange>(this, (msg) =>
        {
            ...
            if (moonlightConfigService.Current.ProfilePopoutRight)
            {
    ...
    protected override void DrawInternal()
    {
        ...
        try
        {
            ...
            var moonlightProfile = _moonlightProfileManager.GetMoonlightProfile(_pair.UserData);
            ...
            var note = _serverManager.GetNoteForUid(new Guid(_pair.UserData.UID));
            ...
            var descText = moonlightProfile.Description;
            ...
            UiSharedService.TextWrapped(trimmed ? descText + $"...{Environment.NewLine}[Open Full Profile for complete description]" : moonlightProfile.Description);
            font.Dispose();
